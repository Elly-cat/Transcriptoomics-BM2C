...
Om te zien of de gen expressie verschilt van rheuma en controle samples werd een PCA plot uitgevoerd (fig. 2). Wat de samples goed clusterd van elkaar en ook met de Bray-curtis afstand werd bevestigd met PERMANOVA (P = 0.036, 999 permutaties). 
(pic, run again)
