...
Uit de volcano plot kwam de de meest opgereuduleerde gen SRGN in reuma patienten voorkomt. SRGN is betrokken bij ontstekingsprocessen doordat het de productie van TNF-α reguleert en het NF-κB-pathway activeert (Chen et al., 2020), dat zorgt voor weefselafsterfte en auto-immunreacties (Liu et al., 2017; D. Jang et al., 2021). Bij de hallmark-analyse kwam de meest upgerugeerlde pathway allograft rejection dat gedoneerde weefsel afstoot, hoewel er geen weefsel is gedoneert is er wel overlap met ander immunomechanismes. De meest neergeruguleerde pathway was myogenisis (spieraanmaak). Deze verstoring zou verband kunnen houden met overproductie van myostatine, een remmer van spiergroei(Gonzalez-Ponce et al., 2024).
