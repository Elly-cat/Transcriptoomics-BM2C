...
Met RSUBread werd de humaan genoom GRCh38.p14 (file) en de monster reads (file) gemapt. Zodat het align-programma weet waar in het genoom de reads passen van de monsters.
